        ...
        private static readonly Dictionary<string, WordClockLayout> Layouts = new(StringComparer.InvariantCultureIgnoreCase)
        {
            // Deutsches Wortuhr-Layout
            {
                ...
                [
                    ...
                    (9, 8, 3),  // 25  UHR
                    (10, 3, 1), // 26  1. Minute (Punkte für Minutenanzeige)
                    (10, 4, 1), // 27  2. Minute (Punkte für Minutenanzeige)
                    (10, 6, 1), // 28  3. Minute (Punkte für Minutenanzeige)
                    (10, 7, 1), // 29  4. Minute (Punkte für Minutenanzeige)
                ])
            },
